...
public class AutoAimStatic extends Command {
     ...
     * @param ySpeed
     */
    public AutoAimStatic(VisionSubsystem visionSubsystem, DriveSubsystem driveSubsystem, DoubleSupplier xSpeed, DoubleSupplier ySpeed){
